...
const CFBSchedule = () => {
    ...
    const formatGameTime = useCallback((datetime) => {
    ...
    const GameCard = ({ game }) => {
        ...
        return (_jsxs("div", { className: `game-card ${statusClass}`, children: [_jsxs("div", { className: "game-header", children: [_jsx("span", { className: "game-time", children: formattedTime }), _jsx("span", { className: `game-status ${statusClass}`, children: game.status })] }), _jsxs("div", { className: "teams", children: [_jsxs("div", { className: "team away-team", children: [_jsxs("div", { className: "team-info", children: [_jsx("img", { src: game.awayTeam?.logo || '/images/logos/default-logo.png', alt: game.awayTeam?.name || 'Away Team', className: "team-logo", onError: (e) => {
                                                e.target.src = '/images/logos/default-logo.png';
                                            } }), _jsxs("div", { className: "team-details", children: [_jsxs("div", { className: "team-name", children: [game.awayTeam?.rank && game.awayTeam.rank <= 25 && _jsxs("span", { className: "rank", children: ["#", game.awayTeam.rank] }), _jsx("span", { className: "team-short-name", children: game.awayTeam?.shortName || 'Unknown' })] }), _jsx("div", { className: "team-conference", children: game.awayTeam?.conference || 'Unknown' })] })] }), _jsx("div", { className: "team-score", children: (game.isCompleted || gameStatus === 'live') ? (game.awayTeam?.score || 0) : '' })] }), _jsx("div", { className: "vs-separator", children: "@" }), _jsxs("div", { className: "team home-team", children: [_jsxs("div", { className: "team-info", children: [_jsx("img", { src: game.homeTeam?.logo || '/images/logos/default-logo.png', alt: game.homeTeam?.name || 'Home Team', className: "team-logo", onError: (e) => {
                                                e.target.src = '/images/logos/default-logo.png';
                                            } }), _jsxs("div", { className: "team-details", children: [_jsxs("div", { className: "team-name", children: [game.homeTeam?.rank && game.homeTeam.rank <= 25 && _jsxs("span", { className: "rank", children: ["#", game.homeTeam.rank] }), _jsx("span", { className: "team-short-name", children: game.homeTeam?.shortName || 'Unknown' })] }), _jsx("div", { className: "team-conference", children: game.homeTeam?.conference || 'Unknown' })] })] }), _jsx("div", { className: "team-score", children: (game.isCompleted || gameStatus === 'live') ? (game.homeTeam?.score || 0) : '' })] })] }), _jsxs("div", { className: "game-details", children: [_jsxs("div", { className: "venue-info", children: [_jsx("span", { className: "venue", children: game.venue }), _jsx("span", { className: "location", children: game.location })] }), _jsxs("div", { className: "broadcast-info", children: [_jsx("span", { className: "tv", children: game.tv }), game.spread && _jsx("span", { className: "spread", children: game.spread })] })] })] }));
    };
    const DateSection = ({ date, games }) => {
