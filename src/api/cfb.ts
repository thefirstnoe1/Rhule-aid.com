...
export async function handleCFBRequest(request: Request, env: any): Promise<Response> {
  ...
  try {
    ...
    const finalResponse: CFBResponse = {
      success: true,
      data: games,
      cached: false,
    ...
    const errorResponse: CFBResponse = {
      success: false,
      data: [],
      cached: false,
      lastUpdated: new Date().toISOString(),
