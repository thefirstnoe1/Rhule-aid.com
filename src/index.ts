...
import { handleGameStatusRequest } from './api/nebraska-game-status';
import { handleGameCalendarRequest } from './api/game-calendar';
import { handleWeatherAlertsRequest } from './api/weather-alerts';
